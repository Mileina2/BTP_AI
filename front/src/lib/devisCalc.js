...
export function computeDevisTotals(lignes, defaultTva = 18, remisePercent = 0, retenueGarantie = 0) {
  return computeDevisAmounts(lignes, defaultTva, remisePercent, retenueGarantie);
}
...
/** @deprecated */
export function calcDevisTotals(lignes, tva = 18, remisePercent = 0, retenueGarantie = 0) {
